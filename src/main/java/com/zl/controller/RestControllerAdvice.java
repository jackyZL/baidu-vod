...
import com.zl.common.CommonResponse;
import com.zl.common.exception.BusinessException;
...
public class RestControllerAdvice implements ResponseBodyAdvice<Object> {
    ...
    public ResponseEntity<CommonResponse> error(HttpServletRequest request, Throwable throwable) {
        ...
        if (throwable instanceof MethodArgumentNotValidException) {
            ...
            responseEntity = new ResponseEntity<CommonResponse>(resp, MessageCode.INVALID_PARAM.httpStatus());
        }
        // 业务错误返回
            ...
            responseEntity = new ResponseEntity<CommonResponse>(resp, be.getMessageCode().httpStatus());
        } else {
            // 系统出错返回
